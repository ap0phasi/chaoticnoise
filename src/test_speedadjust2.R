...
newsignal = adjust_speed(newaudio@.Data[,1],1,0.90)
newaudio@.Data[1:(min(length(newsignal),dim(newaudio@.Data)[1])),1]=newsignal[1:(min(length(newsignal),dim(newaudio@.Data)[1]))]
newsignal = adjust_speed(newaudio@.Data[,2],1,1.1)
newaudio@.Data[1:(min(length(newsignal),dim(newaudio@.Data)[1])),2]=newsignal[1:(min(length(newsignal),dim(newaudio@.Data)[1]))]
